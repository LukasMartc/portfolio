    ...
    <header className="bg-header px-6 py-2.5">
      <div className="grid grid-cols-1 mx-auto md:grid-cols-2">
        <div className="text-white flex justify-center items-start flex-col mb-3">
          ...
          <a href="#" className='my-4 relative inline-flex items-center justify-center p-4 px-5 py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out rounded-full shadow-xl group hover:ring-1 hover:ring-purple-500'>
